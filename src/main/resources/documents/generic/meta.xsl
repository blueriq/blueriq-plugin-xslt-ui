...
<!--
	...
	Date:		2010-06-08
	Description:	meta stylesheet for xsl-fo for Aquima Documents

	Version history:
	20100608 1.0 M. Joosen		Creation

-->

	<!-- Template META -->
	<xsl:template match="META | STYLE[@name='meta'] | STYLE[@name='META'] | *[@style='META'] | *[@style='meta'] "/>
